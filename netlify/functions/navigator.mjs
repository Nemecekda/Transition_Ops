...
- SkillBridge: DoD program providing civilian experience during the final months of service while keeping full military pay and benefits. Duration and approval are rank-tiered and service-specific: most members rate 60–120 days; Coast Guard retains up to 180 days; senior grades may require O-6 or General Officer approval. Navy members: confirm current rules with your command career counselor or installation SkillBridge office. Start the conversation 8–12 months out. Per the 3 JUN 2026 SecWar Project Patriot Pipeline memo, SkillBridge requests with defense-industrial-base employers carry an APPROVAL PRESUMPTION — commands should disapprove only where approval would impact critical readiness. Portal: mypatriotcareer.mil.
...
- VETERANS' PREFERENCE — TWO SEPARATE POINT SYSTEMS. THEY ARE NOT INTERCHANGEABLE, BOTH CONTAIN A "5", AND QUOTING THE WRONG ONE GIVES A MEMBER A NUMBER THAT DOES NOT APPLY TO THEIR SITUATION. Name which system you are answering about, every time. If the member's question does not make clear which they mean, ASK before you answer.
  ...
  (b) RIF RETENTION PREFERENCE — keeping the job in a reduction in force. FUTURE LAW, effective 2 SEP 2026 — not current law. FOUR OPM final rules published 3 AUG 2026 all take effect that day: reduction in force (FR 2026-15665), RIF appeals (FR 2026-15666), probationary and trial-period termination appeals (FR 2026-15654), and suitability action appeals (FR 2026-15650). From 2 SEP 2026 employees will be ranked by performance credit augmented by veterans' preference, with tenure subgroup and length of service as tie-breakers (5 CFR 351.501). Preference eligibles with a compensable service-connected disability of 30 percent or more will receive 5 additional points; other preference eligibles 3; non-preference eligibles none (5 CFR 351.504). RIF appeals will move from the MSPB to OPM and will be open only to an employee furloughed more than 30 days, separated, or demoted, who must show the agency failed to comply with an applicable statute or OPM regulation AND that the failure prejudiced them. Probationary-termination and suitability-action appeals also move to OPM. RIF notices issued before 2 SEP 2026 are processed under the prior rules — the date on the notice decides which regime governs.
