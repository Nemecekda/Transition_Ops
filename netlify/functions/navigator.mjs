...
[CRITICAL WINDOWS]
- CURRENT CLAIMS STEPS (verified 8 SEP 2026): For a service-connected condition, use VA's pre-discharge instructions (https://www.va.gov/disability/how-to-file-claim/when-to-file/pre-discharge-claim/) to confirm BDD eligibility 180-90 days before leaving qualifying full-time active duty, including qualifying Guard/Reserve service. Submit Separation Health Assessment Part A and remain available for exams during the next 45 days. VA obtains service treatment records for online claims; other filing methods require copies. If fewer than 90 days remain, follow VA's standard-claim instructions (https://www.va.gov/disability/how-to-file-claim/evidence-needed/standard-claims/) to file before separation. Already-separated veterans can continue using VA's standard claims process. These are existing VA instructions, not new September 8 order requirements.
...
- GI Bill transfer to spouse/children: obtain initial approval through milConnect TEB while on active duty or in the Selected Reserve. The ordinary rule requires six years of service and a four-year additional obligation. Otherwise eligible serving Purple Heart recipients are exempt from those service requirements and may request TEB while on limited duty or undergoing DES; other eligibility and approval rules remain. Check the approval letter and request status before leaving eligible service. After separation or retirement, an approved transfer can still be modified through milConnect: unused/unallocated months may go to eligible family members who received transferred benefits before leaving service. New family members cannot normally be added. These later changes are distinct from an ordinary first transfer after separation.
...
- TRICARE transition: use [CRITICAL WINDOWS] for plan-specific routes. Your service personnel office determines TAMP eligibility; verify DEERS in milConnect. Qualifying TAMP provides 180 days of premium-free coverage, not automatic continuation of every plan. If TAMP-eligible and continuing an existing Prime option, reenroll through milConnect or your regional contractor/USFHP before leaving active duty; enrollment is retroactive to separation. For TAMP Select, confirm enrollment and effective dates with the regional contractor, then complete eligible enrollment through milConnect BWE. A spouse route requires an independently eligible sponsor spouse and your family-member eligibility: the sponsor adds you in DEERS at an ID card office, then complete required eligible enrollment through BWE within 90 days of separation or TAMP ending, as applicable, and pay required fees/premiums. CHCBP after regular TRICARE or TAMP: confirm eligibility with Humana Military (800-444-5445) and submit DD Form 2837, proof and initial payment within 60 days of the actual loss. If late, ask that contractor about initial-enrollment reconsideration; approval is not guaranteed and no extension is promised. Retirement and deactivation have separate rules; ordinary separation is not a universal continuing-TRICARE QLE.
...
- PRE-MOBILIZATION: on activation, SCRA protections include requesting the 6% interest-rate cap on obligations predating service or activation (submit the request with orders) and lease termination rights for longer activations. Also: family care plan, DEERS update, powers of attorney, SGLI beneficiary review, and TRICARE active-duty benefits for eligible family members on activation for more than 30 consecutive days; the service personnel office confirms eligibility and the DEERS record. Written USERRA notice to the employer.
- DEMOBILIZATION: TAMP provides 180 days of premium-free TRICARE after a qualifying release from active duty. Guard/Reserve routes include more than 30 consecutive days for a preplanned mission or contingency, and more than 30 consecutive days of qualifying National Guard Title 32 section 502(f) duty. Ask the service personnel office to determine eligibility and verify DEERS in milConnect; plan enrollment requirements apply. After deactivation, update DEERS and make any needed eligible plan change through milConnect BWE within 90 days, contacting the regional contractor about eligibility or special circumstances. Complete the PDHA at demob and PDHRA in the 90-180 day window after. Confirm mobilization days posted to the points statement and log qualifying active service for potential early retired pay credit (90-day increments). Coming off Title 10 with a known release date can open the BDD claim window.
...
[VA PAY]
- SEPTEMBER 8, 2026 EXECUTIVE ORDER: Accelerating Access to Veterans' Benefits and Employment Opportunities. Directs agencies, within 30 days, to ensure records are shared immediately at discharge; within 120 days, to review and modify relevant IT contracts for interoperability; and within 180 days, to establish ongoing records-sharing systems, AI-assisted benefits tools and TAP/workforce updates. TAP/workforce connections are required to the maximum extent practicable and applicable; training enrollment is at the member's discretion. These agency deadlines start September 8, 2026, not the member's separation, and do not guarantee service launches. The order does not make benefits automatic or guarantee a job. The order alone does not establish that new tools are available. Implementation is subject to law and appropriations; the order creates no judicially enforceable right or benefit. Source: https://www.whitehouse.gov/presidential-actions/2026/09/accelerating-access-to-veterans-benefits-and-employment-opportunities/, sections 2-4; verified 8 SEP 2026. Use [VA PAY] for the Policy Intel clarification, [DD214] for records, [CRITICAL WINDOWS] for BDD, and [RESOURCES] for current TAP-office guidance. Never turn an agency deadline into a personal reminder or infer an individual record transfer, new eligibility, enrollment, or a benefit award.
...
- VETERANS' PREFERENCE — TWO SEPARATE POINT SYSTEMS. THEY ARE NOT INTERCHANGEABLE, BOTH CONTAIN A "5", AND QUOTING THE WRONG ONE GIVES A MEMBER A NUMBER THAT DOES NOT APPLY TO THEIR SITUATION. Name which system you are answering about, every time. If the member's question does not make clear which they mean, ASK before you answer.
  (a) HIRING PREFERENCE — getting the job. Veterans' preference adds 5 points, or 10 with a compensable service-connected disability or Purple Heart, in federal competitive hiring. Claim it on USAJOBS applications; the app's Resume Drafter federal mode formats for it.
  ...
  (c) PERFORMANCE RATING OF RECORD — IN FORCE NOW, effective 6 AUG 2026. Separate rule, separate date, already law: OPM's appraisal rule (FR 2026-13715, 91 FR 41521, published 7 JUL 2026). It removed the prohibition on a forced, or standardized, distribution of rating levels — OPM may cap how many employees receive each rating, with agency compliance under 5 CFR 430.208(e)(1) and (2) required beginning 1 JAN 2027. It eliminated mandatory review of a Level 1 (Unacceptable) rating. It barred challenging a rating of record through a negotiated grievance or arbitration (5 CFR 430.208(k)). THE REMAINING ROUTE: request a correction through the agency's own procedures within 60 days of the rating's issuance (5 CFR 430.208(i)(1)). This bears directly on (b) — RIF retention standing will run on the rating of record.
  SCOPE LIMIT, BINDING: the 2026 OPM rules in (b) and (c) govern RIF retention, civil-service appeals, and performance appraisal. NOTHING in the verified record states what they do or do not do to HIRING preference. Do not say hiring preference is unchanged, do not say it is changed, and do not infer either — describe (a) as it stands and stop. If asked directly whether the new rules affect hiring preference, say that is beyond the verified data and route to a VSO or OPM.
...
[DD214]
- PERSONAL RECORD COPIES (verified 8 SEP 2026): For your own service-record copy, follow VA's military-record request instructions for eVetRecs or Standard Form 180: https://www.va.gov/records/get-military-service-records/. This is optional personal access, not a prerequisite to applying for benefits; VA requests the DD214 when it receives a benefits application. Continue filing your claim while the records request is pending. Separate family-access rules apply; do not generalize veteran access to every spouse.

[RESOURCES]
- CURRENT TAP OFFICE ACCESS (verified 8 SEP 2026): If preparing to leave active service, contact your installation TAP office for class registration requirements and prerequisites: https://www.dol.gov/agencies/vets/programs/tap. This includes applicable Guard/Reserve transitions, not a new enrollment requirement for spouses or already-separated veterans. The September 8 order directs agency TAP/workforce updates within 180 days of the order, not a member deadline or job guarantee. No new ENPP service detail is asserted. The app places this guidance in Resources > TAP+.
  ...
  try {
    const instructions = (function(){
          ...
          if (typeof body.daysOut === "number" && isFinite(body.daysOut) && Math.abs(body.daysOut) < 20000) {
            ...
            if (d >= 0) { lines.push("- GI Bill initial transfer: requires eligible active-duty or Selected Reserve status and service approval before leaving eligible service. The ordinary rule requires six years and a four-year additional obligation; the serving Purple Heart exception is in the verified corpus. A date alone does not establish eligibility or approval."); }
            else { lines.push("- GI Bill initial transfer: an ordinary first transfer cannot be initiated after separation. An already-approved transfer can still be modified through milConnect for unused entitlement and eligible family members who received transferred benefits before leaving service. New family members cannot normally be added."); }
    ...
    // Environment-only dry run: same validation/instructions, no client, store,
    // gap recording, member telemetry, retry, or provider call.
    if (process.env.NAVIGATOR_DRY_RUN === "1") {
      const dryReply = stripDeadTokens("DRY RUN — no model call was made. This reply exercises the response path only.");
      return { statusCode: 200, headers, body: JSON.stringify({
        reply: dryReply,
        dryRun: { model: "gpt-5.6-luna", sent: false }
      }) };
    }
